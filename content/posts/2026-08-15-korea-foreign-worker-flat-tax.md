---
title: "Korea Plans to Raise the Foreign-Worker Flat Tax to 21%"
...
about: ["Ministry of Economy and Finance", "National Tax Service", "Restriction of Special Taxation Act", "National Assembly of the Republic of Korea"]
services: [tax-vat-compliance, payroll-outsourcing]

key_takeaways:
  - text: "Korea's 2026 tax reform package, announced **3 August 2026**, proposes raising the optional flat income tax rate for foreign employees from 19% to 21%."
    source: [1, 2, 5]
  - text: "The flat rate is currently **19%** of employment income before local income tax, versus progressive rates of 6% to 45%."
    source: [3, 4]
  - text: "Local income tax adds **10%** of the income tax due, so the effective flat rate moves from 20.9% to 23.1% if the proposal passes."
    source: [4, 5]
  - text: "The entry window would be extended by **3 years**, from 31 December 2026 to 31 December 2029, for employees starting work in Korea."
    source: [1, 2, 5]
  - text: "Once elected, the flat rate applies for up to **20 years** from the first day of work in Korea, and all deductions, exemptions and credits are forfeited."
    source: [3, 6]
  - text: "The bills go to Cabinet on **1 September 2026** and must reach the National Assembly by 3 September 2026."
    source: [2, 5]

faq:
  - q: "Is the Korean foreign-worker flat tax rate going up to 21%?"
    a: "It is proposed, not enacted. The Ministry of Economy and Finance included the increase from 19% to 21% in the 2026 tax reform package announced on 3 August 2026. The package amends eleven tax statutes and must pass the National Assembly before it takes effect, with submission due by 3 September 2026 and most measures intended to apply from 1 January 2027. Until the National Assembly votes, the rate in force remains 19% before local income tax. Treat 21% as a planning assumption, not a fact, and do not change withholding until the amendment is promulgated."
  - q: "What is the flat tax rate for foreigners in Korea and how does it work?"
    a: "A foreign executive or employee working in Korea may elect to have their Korean employment income taxed at a single flat rate — currently 19% before local income tax — instead of the progressive scale that runs from 6% to 45%. The election is made either by application to the tax office when filing the annual return, or through the employer at the point of monthly withholding or at year-end settlement. The trade is absolute: elect the flat rate and you forfeit every income deduction, exemption and tax credit, and non-taxable income items are added back into the taxable base."
  - q: "Who does not qualify for the Korean flat tax rate?"
    a: "Two exclusions matter in practice. Day labourers are outside the regime entirely. More relevant to a foreign-invested company, the flat rate does not apply where the employee is a related party to the employing company — meaning either a corporation over whose management the employee has direct or indirect controlling influence, or a private company owned by the employee's relatives. Founder-executives of their own Korean entity therefore frequently fall outside it, which surprises people who assumed the regime was a general expat benefit."
  - q: "Does the 21% proposal affect foreign employees already on the flat rate?"
    a: "The published proposal is a rate change and an extension of the entry deadline; it does not create a grandfathered lower rate for existing electors. On the face of it, an employee who elected 19% would pay the amended rate on income arising in tax years the amendment covers, and the 20-year clock from their first day of work in Korea is unaffected. The transitional wording in the enacted bill is the thing to read — the National Assembly frequently adjusts effective dates during passage, and this is exactly the detail a summary will not tell you."
  - q: "At what salary does the Korean flat tax rate stop being worth it?"
    a: "There is no single crossover figure, because the flat rate is compared against a progressive liability calculated after deductions and credits that vary by household. A single expatriate with few dependants and little deductible spending crosses over at a lower salary than a colleague with a spouse, children, housing costs and pension contributions. The correct method is to run both computations on the individual's actual numbers each year, which is what year-end settlement is for. A rate rise from 19% to 21% moves the crossover point upward, so some employees currently better off on the flat rate would be better off on the progressive scale from 2027."

resources:
  - title: "Ministry of Economy and Finance — press releases"
    url: "https://mofe.go.kr/nw/nes/nesdta.do?menuNo=4010100"
    note: "Where the 2026 tax reform package and its detailed annex are published, and where the enacted version will appear in December"
  - title: "National Tax Service — English portal"
    url: "https://www.nts.go.kr/english/main.do"
    note: "Guides for foreign taxpayers, the year-end settlement process, and the English helpline (82-2-397-1444)"
  - title: "Hometax"
    url: "https://hometax.go.kr"
    note: "Where withholding statements and year-end settlement are actually filed. Korean interface only"
  - title: "Korea Legislation Research Institute — English statutes"
    url: "https://elaw.klri.re.kr/eng_service/main.do"
    note: "Unofficial English translations of the Restriction of Special Taxation Act and the Income Tax Act, useful for reading the actual provision rather than a summary"
  - title: "National Assembly bill information"
    url: "https://likms.assembly.go.kr/bill/main.do"
    note: "Track the eleven tax bills through committee and plenary once submitted in September"
...
> [!KEY] The proposed rate is **21%** before local income tax, up from 19%. With the 10% local income tax surcharge, the all-in rate moves from 20.9% to 23.1%.
...
> [!WARNING] Do not change withholding rates now. The 19% rate remains in force until the National Assembly passes the amendment and it is promulgated, normally in late December. Withholding at 21% before that is over-withholding, and it is your error to correct.
...
> [!ACTION] Before the December vote
> - List every foreign employee on the flat rate and every foreign hire arriving before mid-2028
> - Model 2027 net pay at 23.1% all-in against the current 20.9%
> - Check whether each expatriate contract is gross, net or tax-equalised, and identify who bears the increase
> - Revisit any start date that was pulled forward solely to beat 31 December 2026
> - Flag the employees near the flat-versus-progressive crossover for a real comparison at year-end settlement
> - Do not touch withholding rates until the amendment is promulgated
...
If you are working out how the change lands across a specific Korean payroll — particularly where packages are tax-equalised or where employees are near the crossover — that is the sort of question our [payroll outsourcing](/services/payroll-outsourcing/) and [tax and VAT compliance](/services/tax-vat-compliance/) teams handle as a matter of course. It is also worth reading alongside [how Korean severance pay works](/blog/payroll/severance-pay-korea/), since severance is taxed as retirement income on a separate basis and is not affected by the flat-rate election at all.
